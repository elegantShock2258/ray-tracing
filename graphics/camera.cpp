...
private:
  ...
  Vector3 topLeft, center, image_i, image_j, viewport_u, viewport_v, top_left, originPixel;
...
public:
  Camera(int focal_length, int vh, Vector3 center, int image_height,
    ...
    this->topLeft = this->center - Vector3(0, 0, this->focal_length) -
                    this->viewport_u / 2 - this->viewport_v / 2;
    this->originPixel = this->top_left + 0.5 * (this->image_i + this->image_j);
  }
